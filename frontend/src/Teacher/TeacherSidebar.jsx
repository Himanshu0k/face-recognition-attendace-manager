...
const TeacherSidebar = ({ isSidebarOpen, setIsSidebarOpen, handleLogout }) => {
  const navItems = [
    { name: "Dashboard", icon: LayoutDashboard, path: "/teacher/dashboard" },
    { name: "Attendance History", icon: History, path: "/teacher/attendance-history" },
    { name: "Absence Request", icon: ClipboardEdit, path: "/teacher/absence-request" },
    { name: "Account Details", icon: UserCog, path: "/teacher/account-details" },
  ];
